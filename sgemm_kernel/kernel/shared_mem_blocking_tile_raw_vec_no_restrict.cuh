...
__global__ void sgemm_shared_mem_blocking_tile_raw_vec_no_restrict(
    const float *A, const float *B, float *C, float alpha, float beta, int M,
    int N, int K) {
...
template <int BlockSize, int TileSize>
cudaError_t launch_sgemm_shared_mem_blocking_tile_raw_vec_no_restrict(
  ...
  if (stream) {
    sgemm_shared_mem_blocking_tile_raw_vec_no_restrict<BlockSize, TileSize>
